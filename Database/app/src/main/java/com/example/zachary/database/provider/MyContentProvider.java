package com.example.zachary.database.provider;
...
{
	private static final String AUTHORITY = "com.example.zachary.database.provider.MyContentProvider";
	private static final String TABLE_PRODUCTS = "products";
	public static final Uri CONTENT_URI = Uri.parse("content://" + AUTHORITY + "/" + TABLE_PRODUCTS);
	...
	static
	{
		sURIMatcher.addURI(AUTHORITY, TABLE_PRODUCTS, PRODUCTS);
		sURIMatcher.addURI(AUTHORITY, TABLE_PRODUCTS + "/#", PRODUCTS_ID);
	}
